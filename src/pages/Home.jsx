  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center" onClick={closeMenu}>
        ...
        <CurrentReservation userId={token.id} encodedToken={encodedToken} menuOpen={menuOpen} setError={setError} setAlert={setAlert} setAlertMessage={setAlertMessage}/>
        <div className="divider"/>
        <h2 className="text-xl mt-4 font-semibold">Upcoming Reservations</h2>
        <UpcomingReservations userId={token.id} encodedToken={encodedToken} setError={setError} setAlert={setAlert} setAlertMessage={setAlertMessage}/>
      </div>
    </>
  )
